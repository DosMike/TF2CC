...
public class GameData {
    ...
    public enum Maps {
        ...
        CTF_2Fort_Invasion("ctf_2fort_invasion", new Category[]{Category.Misc}, new GameMode[]{GameMode.CaptureTheFlag}),
        ...
        KOTH_Probed("koth_probed", new Category[]{Category.Misc}, new GameMode[]{GameMode.KingOfTheHill}),
